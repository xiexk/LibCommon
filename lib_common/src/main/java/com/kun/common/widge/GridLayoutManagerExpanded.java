...
public class GridLayoutManagerExpanded extends GridLayoutManager {
  public GridLayoutManagerExpanded(Context context, int spanCount) {
    super(context, spanCount);
  }

  public GridLayoutManagerExpanded(Context context, int spanCount, int orientation, boolean reverseLayout) {
