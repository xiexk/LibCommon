...
public class RegexHelper {
   ...
   * @return
   */
  public static boolean isSmsExact(final CharSequence input) {
    return isMatch(RegexConstants.REGEX_SMS_CODE, input);
  }
  ...
  /**
   * 验证用户名
   * <p>取值范围为a-z,A-Z,0-9,"_",汉字，不能以"_"结尾,用户名必须是4-16位</p>
   *
   * @param input 待验证文本
   * @return {@code true}: 匹配<br>{@code false}: 不匹配
   */
   ...
   * @return
   */
  public static boolean isStrCount(final CharSequence input,int min,int max) {
    String march="^[\\u4e00-\\u9fa5]{"+min+","+max+"}$";
    return isMatch(march, input);
  }
  ...
  public class RegexConstants {
    ...
    /**
     * 正则：用户名，取值范围为a-z,A-Z,0-9,"_",汉字，不能以"_"结尾,用户名必须是4-16位
     */
    public static final String REGEX_USERNAME = "^[\\w\\u4e00-\\u9fa5]{4,16}(?<!_)$";
