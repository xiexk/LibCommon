...
import in.srain.cube.views.ptr.loadmore.DefaultLoadMoreViewFooter;
import in.srain.cube.views.ptr.loadmore.GridViewHandler;
import in.srain.cube.views.ptr.loadmore.ILoadMoreViewFactory;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isDebug()) {
            PtrCLog.d(LOG_TAG, "onMeasure frame: width: %s, height: %s, margin: %s %s %s %s",
